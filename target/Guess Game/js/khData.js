			...
			setTimeout(function() {
				...
				for(var index = 0; index < 10; index++) {
					...
					if(itemIndex == 0) {
						...
						//alert("tabLenghtArray[itemIndex] ="+tabLenghtArray[itemIndex] );
						result
							+= '' +
							'    <hgroup class="khfxRow">' +
							'      <header>2015-10-18  23:32:13</header>' +
							'      <div class="mid">' +
							'        <img class="photo" src="../img/img01.png" >' +
							'        <span><label>昵称：</label>松下百合子</span> ' +
